...
import com.langdetect.ngram.NgramExtractor;
...
public class TechnicalLanguageDetectorImplTest {
    ...
    public final void testDetector1() {
        ...
        Assert.assertEquals(languageDetector.detect("a").get().getLanguage(), "en");
    }

    @Test
    public final void testDetector2() {
        LanguageDetector languageDetector = makeDetector();
        Assert.assertEquals(languageDetector.detect("b d").get().getLanguage(), "fr");
    }

    @Test
    public final void testDetector3() {
        LanguageDetector languageDetector = makeDetector();
        Assert.assertEquals(languageDetector.detect("d e").get().getLanguage(), "en");
    }

    @Test
    public final void testDetector4() {
        LanguageDetector languageDetector = makeDetector();
        Assert.assertEquals(languageDetector.detect("\u3042\u3042\u3042\u3042a").get().getLanguage(), "ja");
    }
}
